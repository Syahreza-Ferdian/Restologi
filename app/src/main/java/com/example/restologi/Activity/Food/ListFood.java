...
import com.example.restologi.Adapter.ListFoodAdapter;
import com.example.restologi.Domain.Foods;
import com.example.restologi.R;
import com.example.restologi.databinding.ActivityListFoodBinding;
...
public class ListFood extends BaseActivity {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (list.size() > 0) {
                        binding.foodListView.setLayoutManager(new LinearLayoutManager(ListFood.this, LinearLayoutManager.VERTICAL, false));
                        binding.foodListView.setAdapter(new ListFoodAdapter(list));
                    }
